          ...
          <Col lg="3">
            <div className="logo">
              ...
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Rerum quam eaque inventore perspiciatis?
              </p>
          ...
          <h5 className="footer__link-title">Contact Us</h5>
            <ListGroup className="footer__quick-links">
                  ...
                  <ListGroupItem  className="ps-0 border-0 d-flex align-items-center gap-3">
                    ...
                    <p className="mb-0">+918888777722</p>
                  </ListGroupItem>
            </ListGroup>
          </Col>

          <Col lg='12' className="text-center pt-5">
            <p className="copyright">Copyright {year},design and develop by Girish Kumar.All rights reserved.</p>
          </Col>
        </Row>
      </Container>
    </footer>
